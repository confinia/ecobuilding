...
|---|---|---|
| [#173](https://github.com/confinia/ecobuilding/issues/173) 1PESI 13xxx port migration | **Dual-published 2026-08-15** (PR [#174](https://github.com/confinia/ecobuilding/pull/174)): all 13xxx listeners live, † trio loopback-only, east-west via `ecobuilding-internal` aliases, both stacks + sandbox + shared + monitoring migrated; router upstreams flip at edge decommission | Await platform edge flip (ecobuilding+staging→13000, sandbox→13400), then retire legacy publishes |
