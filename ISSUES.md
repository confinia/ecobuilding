...
|---|---|---|
| [#144](https://github.com/confinia/ecobuilding/issues/144) Runner-session host-net containers: broken netns | Guarded (PR [#145](https://github.com/confinia/ecobuilding/pull/145) merged: monitoring create-only from the pipeline + listener checks); ~4 h metrics gap 2026-08-11 | Root-cause investigation (runner env vs login session) |
| [#146](https://github.com/confinia/ecobuilding/issues/146) Panel titled with BDNB principal address (Marronniers/Peupliers) | Filed | Small UI fix + test — good first PR through the pipeline |
