...
|---|---|---|
| [#173](https://github.com/confinia/ecobuilding/issues/173) 1PESI 13xxx port migration | **Complete 2026-08-15**: edge flipped by the platform; decommission PR [#176](https://github.com/confinia/ecobuilding/pull/176) retired every legacy publish (80xx/3002/3005/909x/9882), router 13000-only, targets on 13xxx | Follow-up flagged by platform: move grafana (13040, 0.0.0.0+ufw) to the network-join pattern |
