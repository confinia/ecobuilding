...
|---|---|---|
| [#237](https://github.com/confinia/ecobuilding/issues/237) Sélection 3D : clignotement au survol + ancrage au bâtiment | **Mergé main → staging 2026-08-18** (PR [#236](https://github.com/confinia/ecobuilding/pull/236)) : le bâtiment sous le curseur clignote (feature-state sur l'id BDNB promu) et la sélection transmet le centroïde du bâtiment, plus le point au sol (qui titrait la fiche avec l'adresse du voisin en vue inclinée). Validé visuellement sur [sandbox](https://sandbox.ecobuilding.confinia.io) | Prochain promote |
